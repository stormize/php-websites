    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#">Contact</a></li>
         <li><a href="#" data-toggle="modal" data-target="#signin">Profile</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-3">
                <img src="img/it.JPG" class="img-thumbnail img-responsive" alt="Cinque Terre" width="304" height="236">
            </div>
            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-3">
                <img src="img/it.JPG" class="img-thumbnail img-responsive" alt="Cinque Terre" width="304" height="236">
            </div>
            ...
            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-3">
                <img src="img/it.JPG" class="img-thumbnail img-responsive" alt="Cinque Terre">
            </div>
        </div>
        </div>
    </div>
        ...
        <div class="container">
             <div class="well well-lg">
                 <div class="copy text-center">
                     <p>Powerd By @ <span>Ahmed Hdeawy</span></p>
                 </div>
             </div>
        </div>
    </footer>
